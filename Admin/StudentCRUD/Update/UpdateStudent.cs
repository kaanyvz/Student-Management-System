...
namespace schoolManagementSystem.Admin.StudentCRUD.Update
{
    public partial class UpdateStudent : Form
    {
        ...
        public UpdateStudent(string adminUsername, string schoolName)
        {
        ...
        private void _dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == this._dataGridView.Columns["updateButtonColumn"].Index && e.RowIndex >= 0)
            {
                ...
                UpdateStudentVariables updateStudentVariables = new UpdateStudentVariables(studentId,  adminUsername,  schoolName);
